...
instruction time.
  ...
  \FloatBarrier
    \begin{center}
      \begin{longtable}[pos]{| l | c | m{7.5cm} |} \hline         
        \multicolumn{1}{|c|}{\cellcolor[gray]{0.9}\textbf{Name}} & 
        \multicolumn{1}{c|}{\cellcolor[gray]{0.9}\textbf{Length}} & 
        \multicolumn{1}{c|}{\cellcolor[gray]{0.9}\textbf{Description}} \\ \hline
        \endfirsthead
        ...
        pc\_in            & 20  & Stores the next program counter value.\\ \hline
        inst\_mem\_data\_in  & 32  & Stores the intruction word.    \\ \hline
        new\_pc\_out      & 20  & The next program counter value. \\ \hline
        instruction\_reg\_out  & 32   & CPU core fetched instruction. \\ \hline        
  ...
  \FloatBarrier
    \begin{center}
      \begin{longtable}[pos]{| l | c | m{7.5cm} |} \hline         
        ...
        rst                 & 1   & CPU core reset    \\ \hline
        flush               & 1   & Force flush in pipeline registers \\ \hline
        data\_alu\_a\_in    & 32  & Stores the value of ALU input port A.  \\ \hline
        data\_alu\_b\_in    & 32  & Stores the value of ALU input port B. \\ \hline
        new\_pc\_in         & 20  & Stores the next program counter value.\\ \hline
        instruction\_in     & 32  & Stores the intruction word.    \\ \hline        
        opcode              & 3   & Stores the instruction opperation code. \\ \hline
        inst\_function\_in  & 6   & Stores ALU function  \\ \hline
        reg\_rd\_addr1\_in  & 6   & Stores GPR source A address  \\ \hline
        reg\_rd\_addr2\_in  & 6   & Stores GPR source B address  \\ \hline
        reg\_wr\_addr\_in   & 6   & Stores GPR destination address  \\ \hline
        reg\_wr\_en\_in     & 1   & Stores the signal to enable GPR write back. \\ \hline         
        constant\_in        & 32  & Stores the signed extended integer constant. \\ \hline 
        imm\_inst\_in       & 1   & TBD  \\ \hline
        pc\_offset\_in      & 26  & Stores the PC offset in a J-Instruction \\ \hline
        mem\_data\_rd\_en\_in & 1  & Stores read enable for data memory \\ \hline
        mem\_data\_rw\_en\_in & 1  & Stores write enable for data memory \\ \hline
        write\_back\_mux\_sel\_in  & 1 & Stores the select signal for write back Multiplexer. \\ \hline
        branch\_inst\_in    & 1   & TBD \\ \hline
        jump\_inst\_in      & 1   & TBD \\ \hline
        jump\_use\_r\_in    & 1   & TBD \\ \hline
      \end{longtable}
    \end{center} 
