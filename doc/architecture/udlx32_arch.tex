  ...
  \FloatBarrier
    \begin{center}
      \begin{longtable}[pos]{| l | c | c | m{7cm} |} \hline       	
        ...
        reg\_file\_w\_en    & TBD& output  & GPR bank write enable \\ \hline
        ...
        new\_pc             & 20 & output  & Updated value of PC  \\ 
      \end{longtable}
    \end{center}
  ...
  \FloatBarrier
    \begin{center}
      \begin{longtable}[pos]{| l | c | c | m{7cm} |} \hline         
        ...
        sdram\_data_io      & 32  & input  & SDRAM I/O data \\ \hline
  ...
  \FloatBarrier
    \begin{center}
      \begin{longtable}[pos]{| l | c | c | m{7cm} |} \hline         
        ...
        select\_reg\_data     & TBD & input  & Select data to be writen in GPR bank \\ \hline
