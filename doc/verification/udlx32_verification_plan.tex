  ...
  \FloatBarrier
    \begin{center}
      ...
      \begin{longtable}[pos]{| c | m{5cm} | c | c | c | c | c | c |} \hline  %14cm
        ...
        \hline
        \endlastfoot
      	DLX\_T1      & Execution of all instructions of the Arithmetic category.  &	Sim & Unit & DLX\_F1 & 5 & Lauê & 64\% \\ \hline   
        DLX\_T1\_1    & Execution of addi instruction. All the registers are used to store the results of the operation   &	Sim & Unit & DLX\_F1 & 5 & Lauê & 100\% \\ \hline	
        DLX\_T1\_2    & Execution of subi instruction. All the registers are used to store the results of the operation   &	Sim & Unit & DLX\_F1 & 5 & Lauê & 100\% \\ \hline	
        DLX\_T1\_3    & Execution of add instruction. All the registers are used to store the results of the operation   &	Sim & Unit & DLX\_F1 & 5 & Igo & 100\% \\ \hline	
        DLX\_T1\_4    & Execution of sub instruction. All the registers are used to store the results of the operation   &	Sim & Unit & DLX\_F1 & 5 & Igo & 100\% \\ \hline	
  ...
  \FloatBarrier
    \begin{center}
      ...
      \begin{longtable}[pos]{| c | l | c |} \hline  %14cm
        ...
        \hline
        \endlastfoot
      	06/25/2014      & Assertion to the correct fecth\_top operation  &	Completed \\ \hline   	
      	06/25/2014      & Assertion to verify the decode operation 			 &	Completed \\ \hline
      	07/02/2014      & Assertion for the execution block operation 			 &	Completed \\ \hline      	
      	07/02/2014      & Assertion for the memory read and write back 			 &	Completed \\ \hline      	
